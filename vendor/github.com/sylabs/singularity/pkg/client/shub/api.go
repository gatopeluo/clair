...
func getManifest(uri ShubURI, noHTTPS bool, agentValue string) (manifest ShubAPIResponse, err error) {
	...
	fmt.Println(res.Status + " response received, beginning manifest download\n")
	...
	fmt.Println("manifest image name: " + manifest.Name + "\n")
	if err != nil {
		return ShubAPIResponse{}, err
	}
